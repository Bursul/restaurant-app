          ...
          Expanded(
            child: Stack(
              children: <Widget>[
                ...
                ListView.builder(
                    itemCount: products.where((element) => element.categoryId == context.watch<CategoryChange>().category).length,
                    itemBuilder: (context, index) =>
                        ProductCard(product: products.where((element) => element.categoryId == context.watch<CategoryChange>().category).elementAt(index)))
              ],
            ),
          )
        ],
